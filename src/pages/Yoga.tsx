      ...
      <div className="container mx-auto px-4 pt-24">
        ...
        >
          <div className="bg-white rounded-lg shadow-lg p-8">
            <h1 className="text-3xl font-bold text-[#333333] mb-6">Yoga Practice</h1>
            <div className="grid gap-6">
              <div className="bg-[#4A90E2]/10 rounded-lg p-6">
                <div className="flex items-center space-x-3 mb-4">
                  <Activity className="w-6 h-6 text-[#4A90E2]" />
                  <h3 className="text-lg font-semibold">Today's Practice</h3>
                </div>
                <p className="text-gray-600">Your personalized yoga session is ready.</p>
